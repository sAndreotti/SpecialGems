"""
train.py — Task 13: Named Entity Recognition
...
TASK_NAME       = "ner"
DEFAULT_MODEL   = "1b"
DEFAULT_DATASET = "Babelscape/wikineural"
DEFAULT_OUT_DIR = "./checkpoints/task_13_ner"
MAX_SEQ_LENGTH  = 512
...
def train(args):
    ...
    logger.info("Avvio training Task 13 — Named Entity Recognition...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 13 — Named Entity Recognition")
