"""
train.py — Task 22: Multi-Turn Chat
...
TASK_ID         = "22"
TASK_NAME       = "multiturn_chat"
DEFAULT_MODEL   = "4b"
DEFAULT_DATASET = "OpenAssistant/oasst1"
DEFAULT_OUT_DIR = "./checkpoints/task_22_multiturn_chat"
MAX_SEQ_LENGTH  = 4096
...
def row_to_prompt(row: dict) -> str:
    ...
    if SYSTEM_PROMPT:
        return (
            "<start_of_turn>user\n" + SYSTEM_PROMPT + "\n\n"
            "History conversazione: " + user_text + "\n"
            "<end_of_turn>\n<start_of_turn>model\n" + label_str + "\n<end_of_turn>"
        )
    return (
        "<start_of_turn>user\nHistory conversazione: " + user_text + "\n"
...
def train(args):
    ...
    logger.info("Avvio training Task 22 — Multi-Turn Chat...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 22 — Multi-Turn Chat")
