"""
train.py — Task 25: Hate Speech Detection
...
DEFAULT_MODEL   = "1b"
DEFAULT_DATASET = "evalitahf/hatespeech_detection"
DEFAULT_OUT_DIR = "./checkpoints/task_25_hate_speech"
MAX_SEQ_LENGTH  = 256
...
def train(args):
    ...
    logger.info("Avvio training Task 25 — Hate Speech Detection...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 25 — Hate Speech Detection")
