"""
train.py — Task 04: Natural Language Inference
...
TASK_NAME       = "nli"
DEFAULT_MODEL   = "1b"
DEFAULT_DATASET = "MoritzLaurer/multilingual-NLI-26lang-2mil7"
DEFAULT_OUT_DIR = "./checkpoints/task_04_nli"
MAX_SEQ_LENGTH  = 512
...
def train(args):
    ...
    logger.info("Avvio training Task 04 — Natural Language Inference...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 04 — Natural Language Inference")
