"""
dataset_prep.py — Task 03: Topic Classification
...
def prepare_dataset(save_path: str = "./data/task_03") -> DatasetDict:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepara dataset Task 03 — Topic Classification")
    parser.add_argument("--save_path", default="./data/task_03")
