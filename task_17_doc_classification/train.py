"""
train.py — Task 17: Document Classification
...
TASK_ID         = "17"
TASK_NAME       = "doc_classification"
DEFAULT_MODEL   = "1b"
DEFAULT_DATASET = "fancyzhx/ag_news"
DEFAULT_OUT_DIR = "./checkpoints/task_17_doc_classification"
MAX_SEQ_LENGTH  = 512
...
def train(args):
    ...
    logger.info("Avvio training Task 17 — Document Classification...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 17 — Document Classification")
