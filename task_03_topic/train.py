"""
train.py — Task 03: Topic Classification
...
DEFAULT_OUT_DIR = "./checkpoints/task_03_topic"
MAX_SEQ_LENGTH  = 512
SYSTEM_PROMPT   = """Sei un classificatore di topic. Rispondi con una sola parola: World, Sports, Business o Sci-Tech."""
...
def train(args):
    ...
    logger.info("Avvio training Task 03 — Topic Classification...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 03 — Topic Classification")
