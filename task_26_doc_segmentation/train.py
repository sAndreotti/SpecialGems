"""
train.py — Task 26: Document Segmentation
...
TASK_ID         = "26"
TASK_NAME       = "doc_segmentation"
DEFAULT_MODEL   = "1b"
DEFAULT_DATASET = "aharley/rvl_cdip"
DEFAULT_OUT_DIR = "./checkpoints/task_26_doc_segmentation"
MAX_SEQ_LENGTH  = 4096
...
def train(args):
    ...
    logger.info("Avvio training Task 26 — Document Segmentation...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 26 — Document Segmentation")
