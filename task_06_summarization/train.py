"""
train.py — Task 06: Text Summarization
...
DEFAULT_MODEL   = "4b"
DEFAULT_DATASET = "ARTeLab/fanpage"
DEFAULT_OUT_DIR = "./checkpoints/task_06_summarization"
MAX_SEQ_LENGTH  = 2048
...
def train(args):
    ...
    logger.info("Avvio training Task 06 — Text Summarization...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 06 — Text Summarization")
