"""
train.py — Task 02: Intent Classification
...
DEFAULT_OUT_DIR = "./checkpoints/task_02_intent"
MAX_SEQ_LENGTH  = 256
...
def row_to_prompt(row: dict) -> str:
    ...
    user_text = str(row.get("utt", "")).strip()
...
def train(args):
    ...
    logger.info("Avvio training Task 02 — Intent Classification...")
    trainer.train()
...
def parse_args():
    p = argparse.ArgumentParser(description="Task 02 — Intent Classification")
